...
const LabelleBrandOverview = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-[#1D3D6F] mb-3">تقارير Labelle</h1>
      </div>
        ...
        <CardContent className="p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              شوف الفيديو الخاص بكل منصة وطبق معاه الخطوات. كل منصة لها طريقة مخصصة لتقارير Labelle
              </p>
            </div>
          </div>
        </CardContent>
...
export default LabelleBrandOverview;