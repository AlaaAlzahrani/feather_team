...
import { ArrowLeft, ChevronRight, Twitter, ExternalLink, AlertCircle, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-[#1D3D6F]/70 mb-6">
        ...
        <ChevronRight className="w-4 h-4" />
        <span className="text-[#1D3D6F]">إكس</span>
      </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-lg bg-[#DFF7F6] flex items-center justify-center">
            <Twitter  className="w-5 h-5 text-[#1D3D6F]" />
          </div>
        ...
        <p className="text-[#1D3D6F]/70">
          شرح تفصيلي لطريقة تجهيز تقارير منصة إكس ✨
        </p>
      </div>
      ...
      <Card className="mb-8">
        <CardContent className="p-6">
          <YouTubePlayer videoId="7Hg801MFyqo" />
        </CardContent>
      </Card>
      ...
      <Card className="mb-8">
        <CardContent className="p-6">
          ...
          >
            <span className="text-[#1D3D6F]">صفحة تسجيل الدخول لمنصة إكس (تويتر)</span>
      ...
      <div className="flex justify-end">
        <Link
          href="/reports/tasks/daily/process/prepare-reports/platforms/google"
