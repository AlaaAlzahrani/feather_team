...
import { ArrowLeft, ChevronRight, Camera, ExternalLink, AlertCircle } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-lg bg-[#DFF7F6] flex items-center justify-center">
            <Camera className="w-5 h-5 text-[#1D3D6F]" />
          </div>
        ...
        <p className="text-[#1D3D6F]/70">
          شرح تفصيلي لطريقة تجهيز تقارير ميتا ✨
        </p>
      </div>
      ...
      <Card className="mb-8">
        <CardContent className="p-6">
          <YouTubePlayer videoId="FnFPVPt6sy4" />
        </CardContent>
      </Card>
      ...
      <Card className="mb-8">
        <CardContent className="p-6">
          ...
          >
            <span className="text-[#1D3D6F]">صفحة تسجيل الدخول ميتا</span>
