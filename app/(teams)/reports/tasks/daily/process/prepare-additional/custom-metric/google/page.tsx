...
export default function GoogleCustomPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 text-sm text-[#1D3D6F]/70 mb-6">
        ...
        <ChevronLeft className="w-4 h-4" />
        <span className="text-[#1D3D6F]">البحث عن المقياس في قوقل</span>
      </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          ...
          البحث عن المقياس في قوقل
         </h1>
        </div>

        <p className="text-[#1D3D6F]/70">
          شرح تفصيلي لطريقة البحث عن المقياس في قوقل ✨
        </p>
      </div>
      ...
      {/* Next Platform Navigation */}
        ...
        <Link
          href="/reports/tasks/daily/process/prepare-additional/custom-metric/x"
          className="flex items-center gap-2 text-[#F28579] hover:text-[#1D3D6F] transition-colors"
        >
          <span>منصة إكس</span>
